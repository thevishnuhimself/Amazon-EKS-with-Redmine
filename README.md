...
_**Step - 7: Now, it's time to launch our RED-MINE Architecture & connect it to our MYSQL Database. Here also, I have picked up the Passwords & other crucial data from the pre-created secret file that we had created. 
The YML code is as follows-**_
